...
st.set_page_config(page_title="IntelliNews Analytics", layout="wide")

st.title("📊 IntelliNews Analytics")
st.write("AI-powered News Intelligence System")
...
process = st.sidebar.button("Analyze Articles")
...
def narrative_evolution(docs):
    combined = "\n\n".join([d.page_content for d in docs])

    prompt = f"""
    Analyze how the narrative evolves across these articles.
